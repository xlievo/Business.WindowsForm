        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                ...
                else
                {
                    ...
                    var borderSize = _StyleProvider.BorderSize;

                    tabStripHeight = (borderSize + 1) + (itemHeight * this.RowCount);

                    Rectangle rect = new Rectangle(borderSize, tabStripHeight, Width - (borderSize * 2), Height - tabStripHeight - borderSize);
                    switch (this.Alignment)
                    {
                        case TabAlignment.Top:
                            rect = new Rectangle(borderSize, tabStripHeight, Width - (borderSize * 2), Height - tabStripHeight - borderSize);
                            break;
                        case TabAlignment.Bottom:
                            rect = new Rectangle(borderSize, borderSize, Width - (borderSize * 2), Height - tabStripHeight - borderSize);
                            break;
                        case TabAlignment.Left:
                            rect = new Rectangle(tabStripHeight, borderSize, Width - tabStripHeight - borderSize, Height - (borderSize * 2));
                            break;
                        case TabAlignment.Right:
                            rect = new Rectangle(borderSize, borderSize, Width - tabStripHeight - borderSize, Height - (borderSize * 2));
                            break;
                    }
                    return rect;
                }
            ...
            if (this.Width > 0 && this.Height > 0)
            {
                ...
                if (this.TabCount > 0)
                {
                    ...
                    if (this.Alignment <= TabAlignment.Bottom && !this.Multiline)
                    {
                        ...
                        this._TabBufferGraphics.Clip = new Region(new RectangleF(rect.X + _StyleProvider.BorderSize - this._StyleProvider.TabPageMargin.Left,
                                                                                    rect.Y,
                                                                                    rect.Width - (_StyleProvider.BorderSize * 2) + this._StyleProvider.TabPageMargin.Left + this._StyleProvider.TabPageMargin.Right,
                                                                                    rect.Height));
                    }
